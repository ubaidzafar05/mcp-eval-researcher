...
def _correction_structure_hint(report_structure_mode: str) -> str:
    if report_structure_mode == "investigative":
        return (
            "Use investigative structure: Title, Executive Summary, Background and Context, "
            "Key Questions, Evidence and Findings, Deep Analysis, Conflicting Evidence, "
            "Case Studies or Examples, Limitations of Current Knowledge, Implications, "
            "Conclusion, Sources Used."
        )
    if report_structure_mode == "academic_17":
        return (
            "Use academic structure: Abstract, Introduction, Theoretical Framework, Literature Review, "
            "Hypotheses, Methodology, Metrics & Evaluation, Formal Modeling of Prompting, "
            "Empirical Results, Generalization & Scaling Laws, Theoretical Contributions, "
            "Practical Contributions, Limitations, Ethical & Governance Considerations, "
            "Future Research Directions, Conclusion, Appendices, Sources Used."
        )
    return (
        "Prioritize narrative-first structure: Executive Summary, Direct Answer, "
        "Key Findings, Recommendations, 12-Month Action Plan."
    )
...
def _model_kwargs(model_name: str, system_msg: str, user_msg: str) -> dict:
            ...
            for claim_id in extract_claim_ids(revised_report):
                ...
                citations.append(
                    Citation(
                        ...
                        evidence=(doc.snippet or "")[:runtime.config.max_evidence_quote_chars],
