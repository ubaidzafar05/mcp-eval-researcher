...
def load_config(overrides: dict[str, Any] | None = None) -> RunConfig:
    ...
    data: dict[str, Any] = {
        ...
        "stream_stage_idle_seconds_planning": _env_int("STREAM_STAGE_IDLE_SECONDS_PLANNING", 300),
        ...
        "stream_stage_idle_seconds_evaluation": _env_int(
            "STREAM_STAGE_IDLE_SECONDS_EVALUATION", 240
        ),
        "stream_stage_idle_seconds_finalizing": _env_int(
            "STREAM_STAGE_IDLE_SECONDS_FINALIZING", 180
        ),
        "stream_max_runtime_seconds": _env_int("STREAM_MAX_RUNTIME_SECONDS", 1800),
