...
def load_config(overrides: dict[str, Any] | None = None) -> RunConfig:
    ...
    ollama_model_default = os.getenv("OLLAMA_MODEL", "qwen3:8b")
    runtime_profile = str(
        overrides.get("runtime_profile") or os.getenv("RUNTIME_PROFILE", "minimal")
    )
    ...
    data: dict[str, Any] = {
        ...
        "subtopic_count_default": _env_int("SUBTOPIC_COUNT_DEFAULT", 5),
        "subtopic_count_max": _env_int("SUBTOPIC_COUNT_MAX", 7),
        "subreport_target_words": _env_int("SUBREPORT_TARGET_WORDS", 700),
        "subreport_min_claims": _env_int("SUBREPORT_MIN_CLAIMS", 4),
        ...
        "report_structure_mode": os.getenv("REPORT_STRUCTURE_MODE", "investigative"),
        "availability_enforcement_scope": os.getenv(
        ...
        "constrained_brief_min_specific_actions": _env_int(
            "CONSTRAINED_BRIEF_MIN_SPECIFIC_ACTIONS", 3
        ),
        ...
        "relaxed_quality_mode": _env_bool("RELAXED_QUALITY_MODE", False),
        ...
        "min_primary_claims": _env_int("MIN_PRIMARY_CLAIMS", 12),
        ...
        "target_report_words_peak_min": _env_int("TARGET_REPORT_WORDS_PEAK_MIN", 4000),
        "target_report_words_peak_max": _env_int("TARGET_REPORT_WORDS_PEAK_MAX", 6000),
        ...
        "ollama_model_fast": os.getenv("OLLAMA_MODEL_FAST", "qwen2.5-coder:1.5b"),
        "ollama_model_primary": os.getenv("OLLAMA_MODEL_PRIMARY", ollama_model_default),
        "ollama_model_deep": os.getenv("OLLAMA_MODEL_DEEP", "deepseek-r1:14b"),
        "ollama_model_embed": os.getenv("OLLAMA_MODEL_EMBED", "nomic-embed-text"),
        "ollama_probe_timeout_seconds": _env_int("OLLAMA_PROBE_TIMEOUT_SECONDS", 2),
        "router_mode": os.getenv("ROUTER_MODE", "heuristic"),
        "router_model": os.getenv("ROUTER_MODEL", "qwen2.5-coder:1.5b"),
        "router_escalation_threshold": _env_float("ROUTER_ESCALATION_THRESHOLD", 0.70),
        "router_max_context_deep": _env_int("ROUTER_MAX_CONTEXT_DEEP", 6000),
        "router_allow_deep_parallel": _env_bool("ROUTER_ALLOW_DEEP_PARALLEL", False),
        ...
        "insufficient_evidence_output": os.getenv(
        ...
        "max_evidence_quote_chars": _env_int("MAX_EVIDENCE_QUOTE_CHARS", 600),
        "require_corroboration_for_tier_c": _env_bool("REQUIRE_CORROBORATION_FOR_TIER_C", True),
        "min_report_words_deep": _env_int("MIN_REPORT_WORDS_DEEP", 3500),
        "min_claims_deep": _env_int("MIN_CLAIMS_DEEP", 15),
        ...
        "ollama_rpm": _env_int("OLLAMA_RPM", 30),
        ...
        "mcp_web_server_cmd": os.getenv("MCP_WEB_SERVER_CMD", "python -m mcp_server.web_stdio_app"),
        ...
        "mcp_call_timeout_seconds": _env_int("MCP_CALL_TIMEOUT_SECONDS", 45),
        ...
        # Ollama is the sole LLM provider — no cloud routing needed.
        ...
        "llm_request_timeout_seconds_evaluation": _env_int(
            "LLM_REQUEST_TIMEOUT_SECONDS_EVALUATION", 150
        ),
